      ...
      <footer className="text-white bg-black px-10 py-16 max-w-screen-xl mx-auto md:px-8">
        <div className="max-w-lg mx-auto text-center">
          <div className=" mx-auto text-white">
            <span className=" font-bakbak text-4xl">HISI</span>
            <span className=" font-bakbak text-2xl font-normal">
              Technologies
            </span>
          </div>
          <p className="leading-relaxed mt-2 text-[15px] text-white font-mons">
        ...
        <ul className="items-center justify-center mt-8 flex space-x-4 space-y-0 font-mons">
