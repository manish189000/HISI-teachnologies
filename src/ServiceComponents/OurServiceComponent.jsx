...
const OurServiceComponent = () => {
  ...
  return (
    <>
      <section className=" py-20 air:py-0 air:pt-12 air:pb-16">
            ...
            <ul className="grid gap-y-8 gap-x-12 sm:grid-cols-2 grid-cols-3 m480:grid-cols-1">
              {features.map((item, idx) => (
                <li key={idx} className="space-y-3">
                  <div className="w-12 h-12 border shadow-lg text-[#7f7f7f] text-xl rounded-lg flex items-center justify-center">
                    {item.icon}
                  </div>
